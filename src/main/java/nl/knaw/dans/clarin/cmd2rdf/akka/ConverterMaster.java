...
import nl.knaw.dans.clarin.cmd2rdf.akka.message.Result;
...
public class ConverterMaster extends UntypedActor
{
    ...
    public ConverterMaster( final int numberOfWorkers, ActorRef listener )
    {
        ...
        workerRouter = this.getContext()
                .actorOf( new Props(ConverterWorker.class )
    ...
    public void onReceive( Object message )
    {
        if( message instanceof NumberRangeMessage )
        {
            ...
            long segmentLength = numberOfNumbers / 1;
